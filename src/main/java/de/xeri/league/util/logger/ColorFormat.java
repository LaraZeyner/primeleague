...
import de.xeri.league.util.logger.jcolor.AnsiFormat;
import de.xeri.league.util.logger.jcolor.Attribute;
import static de.xeri.league.util.logger.jcolor.Attribute.BOLD;
import static de.xeri.league.util.logger.jcolor.Attribute.DIM;
...
public class ColorFormat {
  ...
  public static final ColorFormat DEFAULT = new ColorFormat(Color.VIOLET.lighter(0.8).text(), DIM());
